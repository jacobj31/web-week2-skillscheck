...
let me = {
	firstName: 'Jacob',
	state: 'The Land Without Smiles',
	age: 26,
	greeter(){return `Hello! My name is ${me.firstName} and I live in ${me.state}`
...
//If the number is GREATER than 100, push 'big' as a string to the answers array. If the number is LESS than or EQUAL to 100, 
...
//create an empty array called 'reversed'. Using a for loop, loop over the passed in array in reverse and add each item to the 
...
total = myNumbers.reduce(function(acc, cur){
	return acc + cur
},0)
...
let myNumbersIndex = []
myNumbers.forEach(function(num, index, array){
...
let totallyAwesome = []
totallyAwesome = (people.reduce(function(acc, cur){
